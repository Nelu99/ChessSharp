...
public class Cal : MonoBehaviour {
	...
	void Awake()
	{
		...
		lvl2 = Resources.Load ("Wcal2", typeof(Sprite)) as Sprite;
	}
	...
	{
		if (x - 2 >= 0 && y - 1 >= 0) {
			if (Matrice.board [x - 2, y - 1] < 10 && Matrice.board [x - 2, y - 1] != 4 && Matrice.moves [x - 2, y - 1] != (-1) && checkMove (x - 2, y - 1) == false)
				return true;
		}
		if (x - 2 >= 0 && y + 1 <= 7) {
			if (Matrice.board [x - 2, y + 1] < 10 && Matrice.board [x - 2, y + 1] != 4 && Matrice.moves [x - 2, y + 1] != (-1) && checkMove (x - 2, y + 1) == false)
		...
		if (x - 1 >= 0 && y - 2 >= 0) {
			if (Matrice.board [x - 1, y - 2] < 10 && Matrice.board [x - 1, y - 2] != 4 && Matrice.moves [x - 1, y - 2] != (-1) && checkMove (x - 1, y - 2) == false)
				return true;
		}
		if (x - 1 >= 0 && y + 2 <= 7) {
			if (Matrice.board [x - 1, y + 2] < 10 && Matrice.board [x - 1, y + 2] != 4 && Matrice.moves [x - 1, y + 2] != (-1) && checkMove (x - 1, y + 2) == false)
		...
		if (lvl == 2) {
			if (y - 2 >= 0) {
				if (Matrice.board [x, y - 2] < 10 && Matrice.board [x, y - 2] != 4 && Matrice.moves [x, y - 2] != (-1) && checkMove (x, y - 2) == false)
					return true;
			}
			if (y + 2 <= 7) {
				if (Matrice.board [x, y + 2] < 10 && Matrice.board [x, y + 2] != 4 && Matrice.moves [x, y + 2] != (-1) && checkMove (x, y + 2) == false)
			...
			if (x + 2 <= 7) {
				if (Matrice.board [x + 2, y] < 10 && Matrice.board [x + 2, y] != 4 && Matrice.moves [x + 2, y] != (-1) && checkMove (x + 2, y) == false)
					return true;
			}
			if (x - 2 >= 0) {
				if (Matrice.board [x - 2, y] < 10 && Matrice.board [x - 2, y] != 4 && Matrice.moves [x - 2, y] != (-1) && checkMove (x - 2, y) == false)
